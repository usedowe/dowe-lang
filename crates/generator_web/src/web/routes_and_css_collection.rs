fn design_css_for_fonts(
    ...
    css.push_str(".rich-text{--dowe-component-display:block;display:var(--dowe-show,var(--dowe-component-display));}.rich-mark{display:inline;}.rich-mark-mark{border-radius:.25em;padding:.05em .18em;background:color-mix(in srgb,currentColor 18%,transparent);}.rich-mark-grad{background:linear-gradient(90deg,currentColor,color-mix(in srgb,currentColor 40%,transparent));-webkit-background-clip:text;background-clip:text;color:transparent;font-weight:700;}.rich-mark-pill{display:inline-flex;align-items:center;border-radius:9999px;padding:.1em .55em;background:color-mix(in srgb,currentColor 14%,transparent);font-weight:700;}.rich-mark-slant{display:inline-block;transform:skew(-9deg);font-style:italic;}.rich-mark-glow{text-shadow:0 0 .75em currentColor;font-weight:700;}.rich-mark-under{text-decoration:underline;text-decoration-thickness:.16em;text-underline-offset:.18em;}.rich-mark-strike{text-decoration:line-through;text-decoration-thickness:.12em;}.rich-mark-box{display:inline-flex;border:1px solid currentColor;border-radius:.35em;padding:.02em .35em;}.rich-mark-wave{text-decoration-line:underline;text-decoration-style:wavy;text-decoration-thickness:.12em;text-underline-offset:.2em;}.rich-mark-neon{font-weight:800;text-shadow:0 0 .25em currentColor,0 0 .65em currentColor;}.rich-mark-pop{display:inline-block;font-weight:800;transform:rotate(-1deg) scale(1.04);}.rich-mark-tag{display:inline-flex;align-items:center;border-radius:.35em;padding:.05em .38em;background:currentColor;color:var(--dowe-background);font-size:.88em;font-weight:800;letter-spacing:.02em;}.rich-mark.is-primary{color:var(--dowe-primary);}.rich-mark.is-secondary{color:var(--dowe-secondary);}.rich-mark.is-tertiary{color:var(--dowe-tertiary);}.rich-mark.is-muted{color:var(--dowe-muted);}.rich-mark.is-success{color:var(--dowe-success);}.rich-mark.is-info{color:var(--dowe-info);}.rich-mark.is-warning{color:var(--dowe-warning);}.rich-mark.is-danger{color:var(--dowe-danger);}.record{min-height:3.75rem;}.record.is-disabled{opacity:.5;pointer-events:none;}.record-main{display:flex;min-width:0;flex:1;flex-direction:column;gap:.125rem;}.record-wave{display:flex;height:2rem;align-items:end;gap:.125rem;padding-top:.25rem;}.record-bar{min-height:.25rem;height:calc(var(--record-bar) * .125rem);flex:1;border-radius:.125rem;background:currentColor;opacity:.34;transform-origin:bottom;}.record.is-recording .record-bar{animation:dowe-record-pulse .8s ease-in-out infinite alternate;}.record.is-paused .record-bar{opacity:.55;}.record-meta{display:flex;justify-content:space-between;gap:.75rem;font-size:.75rem;opacity:.72;}.record-time{font-weight:700;font-variant-numeric:tabular-nums;}.record-status{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}.record-actions{display:flex;align-items:center;gap:.375rem;}.record-btn{border:0;border-radius:9999px;background:rgba(255,255,255,.16);color:inherit;cursor:pointer;font:inherit;font-size:.75rem;font-weight:700;line-height:1;padding:.5rem .7rem;}.record-file{display:none;}@keyframes dowe-record-pulse{from{transform:scaleY(.45);opacity:.34;}to{transform:scaleY(1);opacity:1;}}.toggle-group{--dowe-component-display:inline-flex;display:var(--dowe-show,var(--dowe-component-display));align-items:center;width:fit-content;border-radius:var(--dowe-radiusUi);gap:.25rem;padding:.25rem;}.toggle-group.is-wide{width:100%;}.toggle-group.is-vertical{flex-direction:column;align-items:stretch;}.toggle-group.is-disabled{opacity:.5;pointer-events:none;}.toggle-group-item{display:inline-flex;align-items:center;justify-content:center;gap:.5rem;border:0;border-radius:calc(var(--dowe-radiusUi) * .85);background:transparent;color:inherit;cursor:pointer;font:inherit;font-weight:600;line-height:1;white-space:nowrap;transition:background-color 160ms ease,color 160ms ease,box-shadow 160ms ease;}.toggle-group-item:not(.is-active){opacity:.72;}.toggle-group-item:hover{opacity:1;}.toggle-group.is-wide .toggle-group-item{flex:1;}.toggle-group-xs .toggle-group-item{height:1.5rem;padding:0 .5rem;font-size:.75rem;}.toggle-group-sm .toggle-group-item{height:2rem;padding:0 .625rem;font-size:.8125rem;}.toggle-group-md .toggle-group-item{height:2.5rem;padding:0 .75rem;font-size:.875rem;}.toggle-group-lg .toggle-group-item{height:3rem;padding:0 1rem;font-size:1.125rem;}.toggle-group-icon{width:1.1em;height:1.1em;}.collapsible{--dowe-component-display:block;display:var(--dowe-show,var(--dowe-component-display));width:100%;overflow:hidden;border-radius:var(--dowe-radiusBox);}.collapsible.is-disabled{opacity:.5;pointer-events:none;}.collapsible-header{display:flex;width:100%;align-items:center;justify-content:space-between;gap:.75rem;border:0;background:transparent;color:inherit;padding:.75rem 1rem;text-align:left;cursor:pointer;font:inherit;}.collapsible-label{font-size:.875rem;font-weight:700;line-height:1.25rem;}.collapsible-arrow{display:inline-flex;align-items:center;justify-content:center;width:1.25rem;height:1.25rem;transition:transform 160ms ease;}.collapsible.is-open .collapsible-arrow{transform:rotate(180deg);}.collapsible-content{padding:.75rem 1rem;font-size:.875rem;line-height:1.5;}.countdown{--dowe-component-display:flex;display:var(--dowe-show,var(--dowe-component-display));align-items:flex-start;justify-content:center;gap:.5rem;font-weight:800;font-variant-numeric:tabular-nums;}.countdown-unit{display:flex;flex-direction:column;align-items:center;gap:.25rem;}.countdown-box{display:flex;align-items:center;justify-content:center;border-radius:var(--dowe-radiusBox);}.countdown-digit{line-height:1;}.countdown-label{font-size:.75rem;line-height:1rem;font-weight:500;text-transform:uppercase;letter-spacing:.08em;opacity:.72;}.countdown-separator{font-weight:800;line-height:1;}.countdown-sm .countdown-box{width:2.5rem;height:3rem;}.countdown-sm .countdown-digit{font-size:1.25rem;}.countdown-sm .countdown-separator{margin-top:.5rem;font-size:1.25rem;}.countdown-sm .countdown-label{font-size:.625rem;}.countdown-md .countdown-box{width:3.5rem;height:4rem;}.countdown-md .countdown-digit{font-size:1.875rem;}.countdown-md .countdown-separator{margin-top:.75rem;font-size:1.875rem;}.countdown-lg .countdown-box{width:5rem;height:6rem;}.countdown-lg .countdown-digit{font-size:3rem;}.countdown-lg .countdown-separator{margin-top:1.25rem;font-size:3rem;}.countdown-lg .countdown-label{font-size:.875rem;}.countdown-xl .countdown-box{width:7rem;height:8rem;}.countdown-xl .countdown-digit{font-size:4.5rem;}.countdown-xl .countdown-separator{margin-top:1.75rem;font-size:4.5rem;}.countdown-xl .countdown-label{font-size:1rem;}.map{--dowe-component-display:block;position:relative;display:var(--dowe-show,var(--dowe-component-display));width:var(--map-width,100%);height:var(--map-height,400px);min-height:12rem;overflow:hidden;border-radius:var(--dowe-radiusBox);}.map-container{position:absolute;inset:0;overflow:hidden;background:linear-gradient(135deg,color-mix(in srgb,currentColor 10%,transparent),transparent 42%),var(--dowe-softMuted);}.map-grid{position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.22) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.22) 1px,transparent 1px);background-size:2rem 2rem;opacity:.65;}.map-route{position:absolute;left:14%;right:14%;top:54%;height:.25rem;border-radius:9999px;background:currentColor;opacity:.75;transform:rotate(-10deg);transform-origin:center;}.map-marker,.map-waypoint{position:absolute;z-index:2;transform:translate(-50%,-100%);}.map-marker{display:flex;flex-direction:column;align-items:center;gap:.25rem;border:0;background:transparent;color:inherit;cursor:pointer;font:inherit;}.map-marker-pin{width:1.35rem;height:1.35rem;border-radius:9999px 9999px 9999px 0;background:currentColor;box-shadow:0 .25rem .75rem rgba(15,23,42,.22);transform:rotate(-45deg);}.map-marker.is-start .map-marker-pin{color:var(--dowe-success);}.map-marker.is-end .map-marker-pin{color:var(--dowe-danger);}.map-marker.is-waypoint .map-marker-pin{color:var(--dowe-info);}.map-marker-label{border-radius:9999px;background:rgba(255,255,255,.88);color:var(--dowe-onBackground);padding:.125rem .5rem;font-size:.75rem;font-weight:700;box-shadow:0 .25rem .75rem rgba(15,23,42,.18);white-space:nowrap;}.map-waypoint{width:.65rem;height:.65rem;border-radius:9999px;background:currentColor;opacity:.75;}.map-controls{position:absolute;right:.75rem;top:.75rem;z-index:3;display:flex;flex-direction:column;overflow:hidden;border-radius:var(--dowe-radiusUi);background:rgba(255,255,255,.9);color:var(--dowe-onBackground);box-shadow:0 .25rem 1rem rgba(15,23,42,.16);}.map-controls span{display:flex;width:2rem;height:2rem;align-items:center;justify-content:center;font-weight:800;}.map-controls span+span{border-top:1px solid rgba(15,23,42,.12);}.map-scale{position:absolute;left:.75rem;bottom:.75rem;z-index:3;display:flex;align-items:center;gap:.375rem;border-radius:var(--dowe-radiusUi);background:rgba(255,255,255,.9);color:var(--dowe-onBackground);padding:.25rem .5rem;font-size:.75rem;font-weight:700;}.map-scale span{width:3rem;height:.25rem;background:currentColor;}.map-location-btn{position:absolute;right:.75rem;bottom:.75rem;z-index:3;display:flex;width:2.5rem;height:2.5rem;align-items:center;justify-content:center;border:0;border-radius:9999px;background:rgba(255,255,255,.92);color:var(--dowe-onBackground);box-shadow:0 .25rem 1rem rgba(15,23,42,.18);cursor:pointer;font:inherit;font-weight:800;}");
    ...
    css.push_str(".avatar-group{--dowe-component-display:inline-flex;display:var(--dowe-show,var(--dowe-component-display));align-items:center;max-width:100%;}.avatar-group-list{display:flex;align-items:center;}.avatar-group:not(.is-inline) .avatar{margin-left:-.75rem;box-shadow:0 0 0 3px var(--dowe-background);}.avatar-group:not(.is-inline) .avatar:first-child{margin-left:0;}.avatar-group.is-inline .avatar-group-list{gap:.5rem;}.avatar-group .avatar{flex:0 0 auto;}.avatar-group-counter{display:inline-flex;align-items:center;justify-content:center;margin-left:-.75rem;border-radius:9999px;background:var(--dowe-softMuted);color:var(--dowe-onSoftMuted);box-shadow:0 0 0 3px var(--dowe-background);font-weight:700;}.avatar-group.is-inline .avatar-group-counter{margin-left:0;}.chat-box{--dowe-component-display:flex;display:var(--dowe-show,var(--dowe-component-display));width:100%;max-width:100%;min-height:26rem;flex-direction:column;overflow:hidden;border-radius:var(--dowe-radiusBox);}.chat-box-header{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1rem;border-bottom:1px solid rgba(127,127,127,.22);}.chat-box-user{display:flex;min-width:0;align-items:center;gap:.75rem;}.chat-box-avatar{display:flex;width:2.5rem;height:2.5rem;flex:0 0 auto;align-items:center;justify-content:center;border-radius:9999px;background:var(--dowe-softMuted);color:var(--dowe-onSoftMuted);font-weight:700;object-fit:cover;}.chat-box-user-copy{display:flex;min-width:0;flex-direction:column;}.chat-box-user-copy strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:700;}.chat-box-user-copy span{font-size:.8125rem;opacity:.68;}.chat-box-header-actions{display:flex;gap:.25rem;}.chat-box-icon,.chat-box-tool,.chat-box-send,.chat-box-stop{display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:9999px;background:transparent;color:inherit;cursor:pointer;font:inherit;}.chat-box-icon,.chat-box-tool{width:2rem;height:2rem;opacity:.75;}.chat-box-body{display:flex;min-height:0;flex:1;flex-direction:column;padding:1rem;overflow:auto;}.chat-box-messages{display:flex;flex:1;flex-direction:column;gap:.75rem;}.chat-message{display:flex;max-width:82%;flex-direction:column;gap:.25rem;align-self:flex-start;}.chat-message.is-own{align-self:flex-end;align-items:flex-end;}.chat-bubble{border-radius:1rem;padding:.65rem .85rem;background:var(--dowe-softMuted);color:var(--dowe-onSoftMuted);font-size:.9375rem;line-height:1.4;}.chat-message.is-own .chat-bubble{background:var(--dowe-primary);color:var(--dowe-onPrimary);}.chat-meta{display:flex;gap:.375rem;font-size:.75rem;opacity:.62;}.chat-box-typing{display:flex;align-items:center;gap:.25rem;padding:.5rem .75rem;}.chat-box-typing span{width:.375rem;height:.375rem;border-radius:9999px;background:currentColor;opacity:.45;animation:dowe-chat-typing 1s infinite ease-in-out;}.chat-box-typing span:nth-child(2){animation-delay:.12s;}.chat-box-typing span:nth-child(3){animation-delay:.24s;}.chat-box-footer{padding:1rem;border-top:1px solid rgba(127,127,127,.22);}.chat-box-input-wrap{display:flex;align-items:flex-end;gap:.5rem;border-radius:1.5rem;background:rgba(127,127,127,.12);padding:.375rem .5rem;}.chat-box-input{min-height:2rem;max-height:8rem;flex:1;resize:none;border:0;background:transparent;color:inherit;outline:0;padding:.35rem 0;font:inherit;}.chat-box-send,.chat-box-stop{width:2rem;height:2rem;background:var(--dowe-primary);color:var(--dowe-onPrimary);}.chat-box.is-prompt{min-height:auto;border-radius:1.75rem;}.chat-box.is-prompt .chat-box-header,.chat-box.is-prompt .chat-box-body{display:none;}.empty{--dowe-component-display:flex;display:var(--dowe-show,var(--dowe-component-display));flex-direction:column;align-items:center;justify-content:center;gap:1rem;width:100%;padding:2rem;text-align:center;}.empty-icon{width:min(16rem,100%);height:auto;max-height:16rem;color:currentColor;opacity:.82;}.empty-content{display:flex;max-width:32rem;flex-direction:column;gap:.35rem;}.empty-actions{display:flex;justify-content:center;}.marquee{--dowe-component-display:block;--dowe-marquee-gap:1rem;position:relative;display:var(--dowe-show,var(--dowe-component-display));max-width:100%;overflow:hidden;}.marquee-track{display:flex;width:max-content;gap:var(--dowe-marquee-gap);animation:dowe-marquee-x 20s linear infinite;}.marquee.is-slow .marquee-track{animation-duration:40s;}.marquee.is-fast .marquee-track{animation-duration:10s;}.marquee.is-reverse .marquee-track{animation-direction:reverse;}.marquee.pause-on-hover:hover .marquee-track{animation-play-state:paused;}.marquee.is-vertical{height:16rem;}.marquee.is-vertical .marquee-track{flex-direction:column;animation-name:dowe-marquee-y;}.marquee-content{display:flex;flex:0 0 auto;align-items:center;gap:var(--dowe-marquee-gap);}.marquee.is-vertical .marquee-content{flex-direction:column;}.marquee.has-fade::before,.marquee.has-fade::after{content:\"\";position:absolute;z-index:2;pointer-events:none;}.marquee.has-fade::before{inset-block:0;inset-inline-start:0;width:4rem;background:linear-gradient(to right,var(--dowe-marquee-fade),transparent);}.marquee.has-fade::after{inset-block:0;inset-inline-end:0;width:4rem;background:linear-gradient(to left,var(--dowe-marquee-fade),transparent);}.marquee.is-vertical.has-fade::before{inset-inline:0;inset-block-start:0;width:auto;height:4rem;background:linear-gradient(to bottom,var(--dowe-marquee-fade),transparent);}.marquee.is-vertical.has-fade::after{inset-inline:0;inset-block-end:0;width:auto;height:4rem;background:linear-gradient(to top,var(--dowe-marquee-fade),transparent);}.typewriter{--dowe-component-display:inline-flex;display:var(--dowe-show,var(--dowe-component-display));align-items:baseline;white-space:pre-wrap;}.typewriter-caret{display:inline-block;width:1px;height:1em;margin-left:.125rem;background:currentColor;animation:dowe-typewriter-caret .8s steps(1) infinite;}@keyframes dowe-marquee-x{from{transform:translateX(0);}to{transform:translateX(calc(-50% - var(--dowe-marquee-gap)/2));}}@keyframes dowe-marquee-y{from{transform:translateY(0);}to{transform:translateY(calc(-50% - var(--dowe-marquee-gap)/2));}}@keyframes dowe-chat-typing{0%,80%,100%{transform:translateY(0);opacity:.35;}40%{transform:translateY(-.25rem);opacity:1;}}@keyframes dowe-typewriter-caret{0%,49%{opacity:1;}50%,100%{opacity:0;}}");
...
fn append_theme_fab_slider_dropzone_css(css: &mut String) {
    css.push_str(".theme-toggle,.fab-trigger,.fab-action-button{--dowe-component-display:inline-flex;display:var(--dowe-show,var(--dowe-component-display));align-items:center;justify-content:center;border:0;border-radius:9999px;background:transparent;color:inherit;text-decoration:none;cursor:pointer;transition:transform 180ms ease,background-color 180ms ease,color 180ms ease,border-color 180ms ease;}.theme-toggle-icon,.fab-icon{aspect-ratio:1/1;padding:0;}.theme-icon,.fab-icon-svg{width:1.25em;height:1.25em;flex:0 0 auto;}.theme-icon-sun{display:none;}[data-dowe-theme=\"dark\"] .theme-icon-moon{display:none;}[data-dowe-theme=\"dark\"] .theme-icon-sun{display:block;}.fab-container{--dowe-fab-offset-x:1rem;--dowe-fab-offset-y:1rem;position:absolute;z-index:50;display:flex;flex-direction:column;align-items:center;}.fab-container.is-fixed{position:fixed;}.fab-container.is-top-left{top:var(--dowe-fab-offset-y);left:var(--dowe-fab-offset-x);flex-direction:column-reverse;}.fab-container.is-top-right{top:var(--dowe-fab-offset-y);right:var(--dowe-fab-offset-x);flex-direction:column-reverse;}.fab-container.is-bottom-left{bottom:var(--dowe-fab-offset-y);left:var(--dowe-fab-offset-x);}.fab-container.is-bottom-right{bottom:var(--dowe-fab-offset-y);right:var(--dowe-fab-offset-x);}.fab-container.is-top-left .fab-actions,.fab-container.is-top-right .fab-actions{flex-direction:column-reverse;margin-top:.75rem;margin-bottom:0;}.fab-container.is-top-left .fab-action,.fab-container.is-bottom-left .fab-action{flex-direction:row-reverse;}.fab-actions{display:flex;flex-direction:column;gap:.75rem;margin-bottom:.75rem;}.fab-trigger.is-open{transform:rotate(45deg);}.fab-action{display:flex;align-items:center;justify-content:flex-end;animation:dowe-fab-action-appear .2s ease-out forwards;animation-delay:var(--dowe-fab-action-delay,0ms);opacity:0;transform:scale(.8) translateY(10px);}.fab-action-label{margin-left:.75rem;padding:.375rem .75rem;border-radius:var(--dowe-radiusUi);background:var(--dowe-surface);color:var(--dowe-onSurface);box-shadow:0 8px 22px rgba(15,23,42,.16);font-size:.875rem;line-height:1.25rem;font-weight:600;white-space:nowrap;}.fab-container.is-top-left .fab-action-label,.fab-container.is-bottom-left .fab-action-label{margin-right:.75rem;margin-left:0;}.fab-action-button{width:2.5rem;height:2.5rem;padding:0;box-shadow:0 8px 22px rgba(15,23,42,.16);}@keyframes dowe-fab-action-appear{to{opacity:1;transform:scale(1) translateY(0);}}");
    css.push_str(".slider-wrapper{--dowe-component-display:flex;display:var(--dowe-show,var(--dowe-component-display));flex-direction:column;gap:.125rem;width:100%;transition:all 300ms ease;}.slider-info{display:flex;align-items:center;justify-content:space-between;font-size:.875rem;line-height:1;font-weight:600;}.slider{--dowe-slider-color:var(--dowe-primary);--dowe-slider-progress:0%;appearance:none;width:100%;border:0;border-radius:9999px;outline:0;background:linear-gradient(to right,var(--dowe-slider-color) 0%,var(--dowe-slider-color) var(--dowe-slider-progress),var(--dowe-muted) var(--dowe-slider-progress),var(--dowe-muted) 100%);cursor:pointer;}.slider::-webkit-slider-thumb{appearance:none;border:1px solid white;border-radius:9999px;background:var(--dowe-slider-color);cursor:pointer;}.slider::-moz-range-thumb{appearance:none;border:1px solid white;border-radius:9999px;background:var(--dowe-slider-color);cursor:pointer;}.slider.is-primary{--dowe-slider-color:var(--dowe-primary);}.slider.is-secondary{--dowe-slider-color:var(--dowe-secondary);}.slider.is-tertiary{--dowe-slider-color:var(--dowe-tertiary);}.slider.is-muted{--dowe-slider-color:var(--dowe-onMuted);}.slider.is-success{--dowe-slider-color:var(--dowe-success);}.slider.is-info{--dowe-slider-color:var(--dowe-info);}.slider.is-warning{--dowe-slider-color:var(--dowe-warning);}.slider.is-danger{--dowe-slider-color:var(--dowe-danger);}.slider.is-sm{height:.25rem;margin:.25rem 0;}.slider.is-sm::-webkit-slider-thumb{width:1rem;height:1rem;}.slider.is-sm::-moz-range-thumb{width:1rem;height:1rem;}.slider.is-md{height:.5rem;margin:.5rem 0;}.slider.is-md::-webkit-slider-thumb{width:1.5rem;height:1.5rem;}.slider.is-md::-moz-range-thumb{width:1.5rem;height:1.5rem;}.slider.is-lg{height:1rem;margin:.5rem 0;}.slider.is-lg::-webkit-slider-thumb{width:2rem;height:2rem;}.slider.is-lg::-moz-range-thumb{width:2rem;height:2rem;}");
    css.push_str(".dropzone{position:relative;width:100%;}.dropzone-input{display:flex;width:100%;height:12rem;align-items:center;justify-content:center;border:2px dashed var(--dowe-muted);border-radius:var(--dowe-radiusBox);padding:1.5rem;cursor:pointer;transition:background-color 180ms ease,border-color 180ms ease,color 180ms ease,opacity 180ms ease;}.dropzone-input.is-sm{height:8rem;font-size:.875rem;}.dropzone-input.is-md{height:12rem;font-size:1rem;}.dropzone-input.is-lg{height:16rem;font-size:1.125rem;}.dropzone-input.is-disabled{opacity:.5;cursor:not-allowed;}.dropzone-input.is-error{border-color:var(--dowe-danger);}.dropzone-input.is-active.is-primary{border-color:var(--dowe-primary);background:color-mix(in srgb,var(--dowe-primary) 10%,transparent);}.dropzone-input.is-active.is-secondary{border-color:var(--dowe-secondary);background:color-mix(in srgb,var(--dowe-secondary) 10%,transparent);}.dropzone-input.is-active.is-tertiary{border-color:var(--dowe-tertiary);background:color-mix(in srgb,var(--dowe-tertiary) 10%,transparent);}.dropzone-input.is-active.is-muted{border-color:var(--dowe-onMuted);background:color-mix(in srgb,var(--dowe-muted) 10%,transparent);}.dropzone-input.is-active.is-success{border-color:var(--dowe-success);background:color-mix(in srgb,var(--dowe-success) 10%,transparent);}.dropzone-input.is-active.is-info{border-color:var(--dowe-info);background:color-mix(in srgb,var(--dowe-info) 10%,transparent);}.dropzone-input.is-active.is-warning{border-color:var(--dowe-warning);background:color-mix(in srgb,var(--dowe-warning) 10%,transparent);}.dropzone-input.is-active.is-danger{border-color:var(--dowe-danger);background:color-mix(in srgb,var(--dowe-danger) 10%,transparent);}.dropzone-input.is-active.is-background,.dropzone-input.is-active.is-surface{border-color:var(--dowe-primary);background:color-mix(in srgb,var(--dowe-primary) 5%,transparent);}.dropzone-input.is-ghost{background:transparent;border-color:transparent;}.dropzone-input.is-ghost:hover,.dropzone-input.is-ghost.is-active{background:color-mix(in srgb,var(--dowe-muted) 20%,transparent);}.dropzone-content{display:flex;flex-direction:column;align-items:center;gap:.5rem;}.dropzone-icon{width:2rem;height:2rem;opacity:.5;}.dropzone-placeholder{text-align:center;font-size:.875rem;opacity:.7;}.dropzone-files{display:flex;flex-direction:column;gap:.5rem;margin-top:1rem;}.dropzone-file{display:flex;align-items:center;justify-content:space-between;gap:.75rem;padding:.75rem;border:1px solid var(--dowe-muted);border-radius:var(--dowe-radiusUi);background:color-mix(in srgb,var(--dowe-muted) 30%,transparent);}.dropzone-file-preview{position:relative;width:2.5rem;height:2.5rem;flex:0 0 auto;overflow:hidden;border-radius:calc(var(--dowe-radiusUi) * .75);}.dropzone-file-image{position:absolute;left:50%;top:50%;width:100%;height:100%;object-fit:cover;transform:translate(-50%,-50%);}.dropzone-file-icon{display:flex;width:100%;height:100%;align-items:center;justify-content:center;background:var(--dowe-muted);}.dropzone-file-icon svg{width:1.25rem;height:1.25rem;opacity:.5;}.dropzone-file-info{display:flex;min-width:0;flex:1;flex-direction:column;}.dropzone-file-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:.875rem;font-weight:600;}.dropzone-file-size{font-size:.75rem;opacity:.7;}.dropzone-file-remove{flex:0 0 auto;border:0;border-radius:var(--dowe-radiusUi);padding:.375rem;background:transparent;color:inherit;cursor:pointer;transition:background-color 160ms ease;}.dropzone-file-remove:hover{background:color-mix(in srgb,var(--dowe-muted) 50%,transparent);}.dropzone-file-remove svg{width:1rem;height:1rem;}.field-help.is-danger{color:var(--dowe-danger);}");
}

fn append_view_transition_css(css: &mut String) {
    css.push_str("html.theme-transitioning::view-transition-old(root),html.theme-transitioning::view-transition-new(root){animation:none;mix-blend-mode:normal;}html.theme-transitioning[data-dowe-theme-transition='circle']::view-transition-old(root){z-index:1;}html.theme-transitioning[data-dowe-theme-transition='circle']::view-transition-new(root){z-index:999;animation:dowe-theme-circle-expand .6s ease-in;}@keyframes dowe-theme-circle-expand{from{clip-path:circle(0% at 50% 50%);}to{clip-path:circle(150% at 50% 50%);}}html.theme-transitioning[data-dowe-theme-transition='slide']::view-transition-old(root){animation:dowe-theme-slide-out-left .3s ease-out;}html.theme-transitioning[data-dowe-theme-transition='slide']::view-transition-new(root){animation:dowe-theme-slide-in-right .3s ease-out;}@keyframes dowe-theme-slide-out-left{to{transform:translateX(-100%);}}@keyframes dowe-theme-slide-in-right{from{transform:translateX(100%);}}html.theme-transitioning[data-dowe-theme-transition='fade']::view-transition-old(root){animation:dowe-theme-fade-out .2s ease-out;}html.theme-transitioning[data-dowe-theme-transition='fade']::view-transition-new(root){animation:dowe-theme-fade-in .2s ease-in;}@keyframes dowe-theme-fade-out{to{opacity:0;}}@keyframes dowe-theme-fade-in{from{opacity:0;}}html.theme-transitioning[data-dowe-theme-transition='vertical']::view-transition-old(root){animation:dowe-theme-slide-up .3s ease-out;}html.theme-transitioning[data-dowe-theme-transition='vertical']::view-transition-new(root){animation:dowe-theme-slide-down .3s ease-out;}@keyframes dowe-theme-slide-up{to{transform:translateY(-100%);}}@keyframes dowe-theme-slide-down{from{transform:translateY(100%);}}html.page-transitioning[data-dowe-page-transition='fade']::view-transition-old(root){animation:dowe-page-fade-out .2s ease-out;}html.page-transitioning[data-dowe-page-transition='fade']::view-transition-new(root){animation:dowe-page-fade-in .2s ease-in;}@keyframes dowe-page-fade-out{to{opacity:0;}}@keyframes dowe-page-fade-in{from{opacity:0;}}html.page-transitioning[data-dowe-page-transition='slide']::view-transition-old(root){animation:dowe-page-slide-out .3s ease-out;}html.page-transitioning[data-dowe-page-transition='slide']::view-transition-new(root){animation:dowe-page-slide-in .3s ease-out;}@keyframes dowe-page-slide-out{to{transform:translateX(-30%);opacity:0;}}@keyframes dowe-page-slide-in{from{transform:translateX(30%);opacity:0;}}html.page-transitioning[data-dowe-page-transition='scale']::view-transition-old(root){animation:dowe-page-scale-out .3s ease-out;}html.page-transitioning[data-dowe-page-transition='scale']::view-transition-new(root){animation:dowe-page-scale-in .3s ease-out;}@keyframes dowe-page-scale-out{to{transform:scale(.9);opacity:0;}}@keyframes dowe-page-scale-in{from{transform:scale(1.1);opacity:0;}}");
}
...
document.addEventListener("input",event=>{{const target=event.target;if(!target||!target.dataset)return;if(target.dataset.doweSlider!==undefined)updateSlider(target);if(!activeView||!target.dataset.doweBind)return;if(target.type==="radio"&&!target.checked)return;const value=target.type==="checkbox"?target.checked:target.type==="range"?target.valueAsNumber:target.value;writePath(activeView.state,target.dataset.doweBind,value);renderReactive(activeView);}});
...
fn collect_variant_rules<'a>(
    ...
    match node {
        ...
        ViewNode::ToggleTheme { props } => push_variant_rule(variants, "theme-toggle", &props.style),
        ViewNode::Fab { props, actions } => {
