...
fn render_html_with_context(
    ...
    match node {
        ...
        ViewNode::PasswordField { props } => render_password_field_html(props, context),
        ViewNode::PhoneField { props } => render_phone_field_html(props, context),
        ViewNode::PinField { props } => render_pin_field_html(props, context),
