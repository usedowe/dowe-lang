...
use dowe_components::{
    ...
    icon_component_node, iframe_node, image_component_node, image_cropper_component_node,
    input_node, line_chart_component_node, map_component_node, map_marker_component,
    ...
    overlay_item_component, password_field_component_node, phone_field_component_node,
    pie_chart_component_node, pin_field_component_node, radio_group_component_node,
...
mod tests {
    ...
    use crate::parser::source_parser::parse_source_file;
    use dowe_components::{
        AvatarStatus, Breakpoint, ButtonSize, CanvasBackground, CanvasFit, CarouselIndicatorType,
        CarouselOrientation, CarouselVariant, ChartCurve, ChartLegendPosition, ChartPalette,
        ChartSize, ChatBoxMode, ColorFamily, ColorToken, CommandEntry, ComponentVariant,
        CountdownSize, DividerOrientation, EmptyKind, ImageAspect, ImageLoading, ImageObjectFit,
        MapMarkerIcon, MarqueeOrientation, MarqueeSpeed, NavigationAction, OverlayCornerPosition,
...
page usersPage
  ...
  Video src:"https://example.com/video.mp4"
    ...
    fn parses_layout_bar_regions() {
        let tree = parse_page(
            r#"page barsPage
  AppBar variant:"soft" scheme:"surface" bordered:true blurred:true boxed:true floating:true hideOnScroll:true
    top
      Text
        "Notice"
    start
