...
const VIEWS_SURFACE: &str = r#"{
  ...
  "sizing": ["w", "h", "minW", "minH", "maxW", "maxH", "w minW maxW accept full or container sm through 7xl", "responsive values", "h minH maxH accept vh-<scale>"],
  ...
  "reactiveProps": {"Icon": {"stringSignals": ["name"], "catalog": "shared icon catalog with initial fallback"}, "Button": {"stringSignals": ["variant", "scheme", "size", "rounded"], "booleanSignals": ["loading"], "conditionalIcons": {"props": ["iconStart", "iconEnd"], "boolean": "when:path", "numeric": ["gt", "gte", "lt", "lte"]}}, "SideNav": {"stringSignals": ["variant", "scheme", "size"], "booleanSignals": ["wide"]}, "Code": {"template": "validated {signal.path} placeholders in static content"}},
