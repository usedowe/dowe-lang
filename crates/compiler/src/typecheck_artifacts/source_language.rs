...
const SERVER_SURFACE: &str = r#"{
  ...
  "ai": ["ai result source:\"chat\" prompt:prompt files:files", "ai result source:\"chat\" prompt:prompt files:files model:\"gemma-4-e2b\""],
  ...
  "serverConfigModules": ["any imported .dowe module", "classified by database, cache, vector, or queue declaration", "ipc databases:[<imported-database> ...] registers local Database handles for native IPC functions", "database appDb provider:\"dowe\" host:env.DB_HOST port:env.DB_PORT account:env.DB_USER secret:env.DB_PASSWORD name:\"app\" entities:[Users] seeders:[Bootstrap]", "cache appCache provider:\"kv|redis|dowe\" or provider:env.CACHE_PROVIDER host:env.CACHE_HOST port:env.CACHE_PORT account:env.CACHE_USER secret:env.CACHE_PASSWORD name:env.CACHE_NAME", "vector appVector provider:\"dowe\" host:env.VECTOR_HOST port:env.VECTOR_PORT account:env.VECTOR_USER secret:env.VECTOR_PASSWORD name:env.VECTOR_DATABASE", "queue appQueue provider:\"dowe|rabbitmq|cloudflare|vercel\" host:env.QUEUE_HOST port:env.QUEUE_PORT account:env.QUEUE_USER secret:env.QUEUE_PASSWORD vhost:env.QUEUE_VHOST"],
...
const VIEWS_SURFACE: &str = r#"{
  "scaffoldProps": ["Scaffold safeAreaTop:\"surface\" safeAreaBottom:\"primary\"", "omitted safe-area colors default to background"],
  "root": "main.dowe",
  ...
  "components": ["Box", "Section", "Flex", "Grid", "Input", "Select", "Option", "Slider", "Dropzone", "ComboBox", "comboOption", "CsvField", "csvColumn", "DragDrop", "dragGroup", "dragItem", "Editor", "ImageCropper", "Password", "Phone", "Pin", "Textarea", "Code", "Video", "Device", "Canvas", "Game", "Draw", "Candlestick", "Diagram", "ArcChart", "AreaChart", "BarChart", "LineChart", "PieChart", "Table", "Tree", "Pagination", "Divider", "Button", "ToggleTheme", "SelectTheme", "Fab", "fabAction", "Alert", "Icon", "Svg", "Path", "Card", "AppBar", "Footer", "BottomBar", "SideNav", "RailNav", "Sidebar", "NavMenu", "Scaffold", "Splash", "Tabs", "tab", "Stepper", "step", "Drawer", "Avatar", "AvatarGroup", "Badge", "Chip", "Skeleton", "Modal", "AlertDialog", "Tooltip", "Toast", "Dropdown", "Command", "ChatBox", "Empty", "Marquee", "TypeWriter", "RichText", "mark", "Record", "ToggleGroup", "Collapsible", "Countdown", "Map", "marker", "waypoint", "Audio", "Camera", "Microphone", "Image", "Accordion", "Carousel", "Checkbox", "Color", "Date", "DateRange", "RadioGroup", "RadioCard", "Toggle", "Title", "Text"],
  "radioCard": ["RadioCard bind:workspace label:\"Workspace\"", "item value:\"local\" title:\"Local\" description:\"Files on this computer\" icon:\"laptop\"", "item value:\"remote\" title:\"Remote\" description:\"Choose a connected machine\" icon:\"global\""],
  ...
  "reactivity": ["signal", "signal session scope:\"global\" storage:\"local\" value:{ ... }", "fn params:{ form:Form } return:\"boolean\"", "request route:\"/api/...\"", "request path:\"/...\"", "request base:env.NAME", "request headers:{ Authorization:session.authorization }", "onSuccess alert:\"...\"", "onError alert:\"...\"", "implicit BACKEND_URL for /api", "set target value:signal.field", "set target value:!signalBool", "set target value:true", "reset", "Input bind:signal.field", "Select bind:signal.field", "ComboBox bind:signal.field", "Editor bind:signal.field language:\"dowe\" onSave:save", "ImageCropper bind:signal.field", "Password bind:signal.field", "Phone bind:signal.field", "Pin bind:signal.field", "Textarea bind:signal.field", "Slider bind:signal.number", "Button onClick:fn", "\"Fab onClick:fn\"", "fabAction onClick:fn", "Avatar onClick:fn", "AvatarGroup items:avatars item onClick:fn", "ChatBox messages:messages onSend:sendMessage", "ChatBox loading:isLoading sending:isSending streaming:isStreaming hasMore:hasMore", "Record onStart:onRecordStart onPause:onRecordPause onConfirm:onRecordConfirm", "ToggleGroup bind:signalString onChange:fn", "Pagination bind:page total:50 pageSize:10 onChange:loadPage", "Countdown onComplete:fn", "Map onLocation:fn onLocationError:fn onRoute:fn marker onClick:fn", "Empty onClick:fn", "Chip onClose:fn", "Modal onClose:fn bind:signalBool", "AlertDialog onConfirm:fn onCancel:fn bind:signalBool", "Dropdown item onClick:fn", "Command bind:signalBool item onClick:fn", "Toast source:signalObject", "show:signalBool", "Drawer bind:signalBool", "\"{blog.title}\" dynamic text child", "\"blog.title\" literal text child", "\"RichText mark text:\"...\" style:\"grad\"\"", "Code content:\"\"\"...\"\"\"", "Video src:\"https://...\"", "Candlestick data:signal stream:\"/api/...\"", "LineChart data:signal series:signal", "Diagram nodes:signal edges:signal", "AreaChart data:signal series:signal", "BarChart data:signal", "ArcChart data:signal", "PieChart data:signal", "Table data:signal column field:\"name\" label:\"Name\"", "Tree data:signal bind:selected onSelect:fn", "Tabs tab children", "Stepper step children", "Fab fabAction children", "ComboBox comboOption children", "CsvField csvColumn children", "DragDrop dragItem dragGroup children", "NavMenu item submenu megamenu children", "Scaffold appBar start main end bottomBar overlays regions", "Modal header footer regions", "Drawer header body footer regions", "Dropdown trigger item divider regions", "Command group item entries", "Marquee children", "TypeWriter item text:\"...\"", "Collapsible label:\"Details\" children", "Map marker id:\"office\" lat:4.71 lng:-74.07", "Divider orientation:\"horizontal\"", "Svg Path children", "AppBar mobileMenu bind:<signal> header body footer plus top start center end bottom regions", "BottomBar tab href label Icon featured"],
  ...
  "reactiveProps": {"Icon": {"stringSignals": ["name"], "catalog": "shared icon catalog with initial fallback"}, "Button": {"stringSignals": ["variant", "scheme", "size", "rounded"], "booleanSignals": ["loading"], "conditionalIcons": {"props": ["iconStart", "iconEnd"], "boolean": "when:path", "numeric": ["gt", "gte", "lt", "lte"]}}, "SideNav": {"stringSignals": ["variant", "scheme", "size"], "booleanSignals": ["wide"]}, "Image": {"stringSignals": ["src"], "accepted": "quoted packaged or HTTPS source, or a string constant, Signal, or each-item path"}, "Iframe": {"stringSignals": ["src"], "accepted": "quoted HTTPS or internal route, or a string constant, Signal, or each-item path"}, "Code": {"template": "validated {signal.path} placeholders in static content"}},
