...
const SERVER_SURFACE: &str = r#"{
  ...
  "outboundHttp": ["http.get", "http.post", "base", "path", "bearer", "json", "mode:\"json\"", "mode:\"proxy\""],
...
const VIEWS_SURFACE: &str = r#"{
  ...
  "components": ["Box", "Section", "Flex", "Grid", "Input", "Select", "Option", "Slider", "Dropzone", "Code", "Video", "Candlestick", "Table", "Divider", "Button", "ToggleTheme", "Fab", "fabAction", "Alert", "Svg", "Path", "Card", "AppBar", "Footer", "BottomBar", "SideNav", "Sidebar", "NavMenu", "Scaffold", "Tabs", "tab", "Drawer", "Avatar", "AvatarGroup", "Badge", "Chip", "Skeleton", "Modal", "AlertDialog", "Tooltip", "Toast", "Dropdown", "Command", "ChatBox", "Empty", "Marquee", "TypeWriter", "RichText", "mark", "Record", "ToggleGroup", "Collapsible", "Countdown", "Map", "marker", "waypoint", "Audio", "Image", "Accordion", "Carousel", "Checkbox", "Color", "Date", "DateRange", "RadioGroup", "Toggle", "Title", "Text"],
  "slots": ["children", "start", "center", "end", "appBar", "main", "bottomBar", "content", "header", "footer", "trigger", "icon", "group", "item", "mark", "marker", "waypoint", "divider"],
