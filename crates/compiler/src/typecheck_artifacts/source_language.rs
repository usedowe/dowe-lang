...
const VIEWS_SURFACE: &str = r#"{
  ...
  "slots": ["children", "start", "center", "end", "appBar", "main", "bottomBar", "content", "header", "footer", "trigger", "icon", "group", "item", "mark", "marker", "waypoint", "divider", "comboOption", "csvColumn", "dragGroup", "dragItem"],
