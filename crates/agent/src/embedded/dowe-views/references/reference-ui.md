...
The embedded `dowe-views` visual QA script resource can initialize the blueprint when the agent
materializes it for the current run. Keep the resulting blueprint only under
`.dowe/visual-qa/<screen>/blueprint.json`.
