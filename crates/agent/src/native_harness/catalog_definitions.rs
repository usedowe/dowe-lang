...
const UNITS: &[Unit] = &[
    ...
    Unit {
        id: "views/blocks",
        bundle: "views",
        resource: "references/blocks/index.json",
        sections: &[],
    },
    Unit {
        id: "views/blocks/hero",
        bundle: "views",
        resource: "references/blocks/hero-editorial.md",
        sections: &[],
    },
    Unit {
        id: "views/blocks/metrics",
        bundle: "views",
        resource: "references/blocks/proof-metrics.md",
        sections: &[],
    },
    Unit {
        id: "views/blocks/split-media",
        bundle: "views",
        resource: "references/blocks/split-media.md",
        sections: &[],
    },
    Unit {
        id: "views/blocks/opportunity",
        bundle: "views",
        resource: "references/blocks/opportunity-band.md",
        sections: &[],
    },
    Unit {
        id: "views/blocks/growth",
        bundle: "views",
        resource: "references/blocks/growth-ladder.md",
        sections: &[],
    },
    Unit {
        id: "views/blocks/cta",
        bundle: "views",
        resource: "references/blocks/media-cta.md",
        sections: &[],
    },
    Unit {
        id: "views/blocks/faq",
        bundle: "views",
        resource: "references/blocks/faq-editorial.md",
        sections: &[],
    },
    Unit {
        id: "views/blocks/contact",
        bundle: "views",
        resource: "references/blocks/contact-panel.md",
        sections: &[],
    },
    Unit {
        id: "views/svg",
