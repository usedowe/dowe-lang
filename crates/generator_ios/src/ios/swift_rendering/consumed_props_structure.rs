fn register_swift_structure_consumed_props(node: &ViewNode, context: &SwiftReactiveContext) {
    match node {
        ...
        ViewNode::Candlestick { .. } => register_swift_chart_consumed_props(
            dowe_components::BuiltinComponent::Candlestick,
            context,
        ),
        ViewNode::ArcChart { .. } => register_swift_chart_consumed_props(
            dowe_components::BuiltinComponent::ArcChart,
            context,
        ),
        ViewNode::AreaChart { .. } => register_swift_chart_consumed_props(
            dowe_components::BuiltinComponent::AreaChart,
            context,
        ),
        ViewNode::BarChart { .. } => register_swift_chart_consumed_props(
            dowe_components::BuiltinComponent::BarChart,
            context,
        ),
        ViewNode::LineChart { .. } => register_swift_chart_consumed_props(
            dowe_components::BuiltinComponent::LineChart,
            context,
        ),
        ViewNode::PieChart { .. } => register_swift_chart_consumed_props(
        ...
        ViewNode::Tabs { props, .. } => {
            ...
            register_swift_structural_consumed_props(
                component,
                context,
            ...
            register_swift_structural_item_consumed_props(
                component,
        ...
        ViewNode::Accordion { .. } => register_swift_structural_item_consumed_props(
        ...
        ViewNode::Carousel { .. } => register_swift_structural_consumed_props(
        ...
        ViewNode::Table { .. } => register_swift_structural_item_consumed_props(
        ...
        ViewNode::Tree { .. } => register_swift_structural_consumed_props(
        ...
        ViewNode::Svg { .. } => register_swift_structural_consumed_props(
        ...
        ViewNode::Game { .. } => register_swift_structural_consumed_props(
            dowe_components::BuiltinComponent::Game,
            context,
            &[
        ...
        ViewNode::Modal { .. } => register_swift_structural_consumed_props(
            dowe_components::BuiltinComponent::Modal,
            context,
            &[("bind", "ModalProps.open")],
        ),
        ViewNode::AlertDialog { .. } => register_swift_structural_consumed_props(
            dowe_components::BuiltinComponent::AlertDialog,
            context,
            &[("bind", "AlertDialogProps.open")],
        ),
        ViewNode::Command { .. } => register_swift_structural_consumed_props(
            dowe_components::BuiltinComponent::Command,
            context,
            &[("bind", "CommandProps.open")],
        ),
        ViewNode::Toast { .. } => register_swift_structural_consumed_props(
            dowe_components::BuiltinComponent::Toast,
            context,
            &[("source", "ToastProps.source")],
        ),
        ViewNode::AppBar { .. } => register_swift_structural_consumed_props(
        ...
        ViewNode::Footer { .. } => register_swift_structural_consumed_props(
        ...
        ViewNode::Sidebar { .. } => register_swift_structural_consumed_props(
        ...
        ViewNode::Scaffold { .. } => register_swift_structural_consumed_props(
        ...
        ViewNode::Drawer { .. } => register_swift_structural_consumed_props(
