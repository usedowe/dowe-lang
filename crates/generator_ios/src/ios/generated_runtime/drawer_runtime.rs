        ...
        func show(from anchor: UIView) {
            ...
            if controller.view.superview == nil {
                ...
                NSLayoutConstraint.activate([
                    controller.view.leadingAnchor.constraint(equalTo: window.safeAreaLayoutGuide.leadingAnchor),
                    controller.view.trailingAnchor.constraint(equalTo: window.safeAreaLayoutGuide.trailingAnchor),
                    controller.view.topAnchor.constraint(equalTo: window.safeAreaLayoutGuide.topAnchor),
