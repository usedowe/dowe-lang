...
pub fn collect_node_font_families(node: &ViewNode, fonts: &mut BTreeSet<FontFamily>) {
    match node {
        ...
        ViewNode::SelectTheme { props } => collect_style_font_families(&props.style.style, fonts),
        ...
        ViewNode::Iframe { props } => collect_style_font_families(&props.style, fonts),
        ...
        ViewNode::Game { props } => collect_style_font_families(&props.style, fonts),
