pub fn container_component_node(
    ...
    match component {
        ...
        BuiltinComponent::Device => device_node(props, children),
        ...
        BuiltinComponent::RailNav => Err(ComponentError::invalid_prop_combination(
        ...
        BuiltinComponent::Splash => Err(ComponentError::invalid_prop_combination(
