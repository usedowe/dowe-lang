fn dev_activity_canvas_runtime() -> &'static str {
    ...
    private int doweCanvasColor(Object value) {
        ...
        if ("onPrimary".equals(token)) return DOWE_ON_PRIMARY;
        if ("secondary".equals(token)) return DOWE_SECONDARY;
        if ("onSecondary".equals(token)) return DOWE_ON_SECONDARY;
        if ("tertiary".equals(token)) return DOWE_TERTIARY;
        if ("onTertiary".equals(token)) return DOWE_ON_TERTIARY;
        if ("muted".equals(token)) return DOWE_MUTED;
        if ("onMuted".equals(token)) return DOWE_ON_MUTED;
        if ("background".equals(token)) return DOWE_BACKGROUND;
        if ("onBackground".equals(token) || "foreground".equals(token) || "currentColor".equals(token)) return DOWE_ON_BACKGROUND;
        if ("surface".equals(token)) return DOWE_SURFACE;
        if ("onSurface".equals(token)) return DOWE_ON_SURFACE;
        if ("success".equals(token)) return DOWE_SUCCESS;
        if ("onSuccess".equals(token)) return DOWE_ON_SUCCESS;
        if ("info".equals(token)) return DOWE_INFO;
        if ("onInfo".equals(token)) return DOWE_ON_INFO;
        if ("warning".equals(token)) return DOWE_WARNING;
        if ("onWarning".equals(token)) return DOWE_ON_WARNING;
        if ("danger".equals(token)) return DOWE_DANGER;
        if ("onDanger".equals(token)) return DOWE_ON_DANGER;
        if ("softPrimary".equals(token)) return DOWE_SOFT_PRIMARY;
        if ("onSoftPrimary".equals(token)) return DOWE_ON_SOFT_PRIMARY;
        if ("softSecondary".equals(token)) return DOWE_SOFT_SECONDARY;
        if ("onSoftSecondary".equals(token)) return DOWE_ON_SOFT_SECONDARY;
        if ("softTertiary".equals(token)) return DOWE_SOFT_TERTIARY;
        if ("onSoftTertiary".equals(token)) return DOWE_ON_SOFT_TERTIARY;
        if ("softMuted".equals(token)) return DOWE_SOFT_MUTED;
        if ("onSoftMuted".equals(token)) return DOWE_ON_SOFT_MUTED;
        if ("softSuccess".equals(token)) return DOWE_SOFT_SUCCESS;
        if ("onSoftSuccess".equals(token)) return DOWE_ON_SOFT_SUCCESS;
        if ("softInfo".equals(token)) return DOWE_SOFT_INFO;
        if ("onSoftInfo".equals(token)) return DOWE_ON_SOFT_INFO;
        if ("softWarning".equals(token)) return DOWE_SOFT_WARNING;
        if ("onSoftWarning".equals(token)) return DOWE_ON_SOFT_WARNING;
        if ("softDanger".equals(token)) return DOWE_SOFT_DANGER;
        if ("onSoftDanger".equals(token)) return DOWE_ON_SOFT_DANGER;
