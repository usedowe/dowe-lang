...
pub use dowe_agent::native_harness::{
    ...
    SessionEventReceipt, SessionExtensionCall, SessionExtensionRegistry, SessionExtensionResult,
    SessionExtensionToolDescriptor, SessionObserver, SessionObserverHandle,
    session_extension_descriptor_fingerprint, session_extension_fingerprint,
    validate_session_extension_descriptors,
};
pub use dowe_agent::{
